  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Welcome to DiscountifyME! Please check your email to verify your account.",
      })
    }, 1500)
  }
      ...
      <div className="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>Join DiscountifyME and start discovering amazing local deals</CardDescription>
          </CardHeader>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="updates" className="text-sm text-gray-600">
                    Subscribe to deal alerts and updates
                  </Label>
                </div>
              </div>
